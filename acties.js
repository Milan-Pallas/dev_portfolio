...
const html_kennis = `
    ...
    programmeertalen om leuke en interactieve elementen te creëren.
`;
const css_kennis = `
...
const javascript_kennis = `
    Ik heb nog maar een basis kennis met Javascript. Ik kan werken met gewone en async functies,  eventlisteners en API's.
    Dit leuke element is ook gemaakt Javascript :)
`;
const mysql_Kennis = `
    Gij denkt dat ik deze nu al ga uit typen?
`;
const CSharp_kennis = `
    C# is voor mij nog wat lastig. Ik heb een basis kennis over classes, methods en constructors.
